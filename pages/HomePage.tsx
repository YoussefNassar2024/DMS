...
const ServiceCard: React.FC<{ icon: React.ReactNode; title: string; description: string; index: number }> = ({ icon, title, description, index }) => (
    <div className="group relative bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 will-animate h-full" style={{ animationDelay: `${0.2 + index * 0.1}s` }}>
        ...
        <div className="overflow-x-hidden pt-0">
            ...
            <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center text-dms-gray overflow-hidden bg-white pt-20">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute bottom-1/4 -right-20 w-[600px] h-[600px] bg-dms-blue/5 rounded-full blur-[140px] animate-gradient-xy" style={{animationDelay: '3s'}}></div>
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    <div className="mb-8 inline-block">
                        <span className="inline-block px-4 py-1.5 rounded-full bg-dms-gray/5 border border-dms-gray/10 text-[10px] uppercase tracking-[0.4em] font-black text-dms-gray/60 animate-fade-in opacity-0" style={{animationFillMode: 'forwards'}}>
                            Trust the Data in Clearwater, FL
                        </span>
                    </div>
                    <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-black mb-10 tracking-tighter leading-[0.95] uppercase animate-fade-in-up text-dms-gray">
                        Dependable<br/>
                    ...
                    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                        <p className="text-base sm:text-lg md:text-xl text-gray-500 font-medium leading-relaxed">
                            The Internet is highly competitive. We understand using the right marketing strategies is essential to elevate your business above all others. We provide the digital marketing services you need for real results.
                        </p>
                    </div>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-12 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                        <button 
            ...
            <section className="py-24 md:py-32 bg-dms-light-gray relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 md:gap-20 items-center">
                    ...
                    <div className="will-animate order-1 md:order-2">
                        ...
                        <button onClick={() => navigateTo('about')} className="flex items-center gap-4 text-dms-gray font-black uppercase tracking-widest group text-xs">
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 sm:mb-20 gap-8">
                        <div className="will-animate">
                            <span className="text-dms-green font-black text-[10px] uppercase tracking-[0.4em] mb-4 block">Our Solutions</span>
                        ...
                        <p className="max-w-md text-gray-400 font-medium will-animate text-sm" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto text-center will-animate">
                        ...
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <div>
                                <div className="font-black uppercase tracking-widest text-[10px] sm:text-xs text-dms-green">Trust the Data</div>
                                <div className="text-[9px] sm:text-[10px] text-white/50 uppercase tracking-widest mt-1">Clearwater, FL</div>
                            </div>
                            <div className="w-8 sm:w-12 h-[1px] bg-dms-green"></div>
                        </div>
                    </div>
