            ...
            <div className={`w-full md:w-1/2 ${isReversed ? 'md:order-2' : ''}`}>
                <div className="mb-8">
                    ...
                    <div className="flex items-center mb-6">
                        <div className="p-5 bg-dms-light-gray rounded-3xl mr-6 text-dms-blue shadow-inner group-hover:scale-110 transition-transform duration-700">
                            <service.icon className="w-10 h-10 lg:w-12 lg:h-12" />
                        </div>
                        <h2 className="text-3xl lg:text-5xl font-black text-dms-gray tracking-tighter uppercase leading-none">
                            {service.title}
                        </h2>
                    </div>
                </div>
                <p className="text-gray-500 text-lg lg:text-xl font-light leading-relaxed mb-10 max-w-xl">
                    {service.description}
                </p>
                <button 
                    onClick={() => navigateTo('contact')} 
                    className="inline-flex items-center gap-6 bg-dms-gray text-white py-5 px-10 rounded-full font-bold uppercase tracking-[0.3em] text-[10px] hover:bg-dms-green transition-all duration-500 group shadow-xl hover:shadow-dms-green/20"
                >
                    Get a Quote
            ...
            <div className={`w-full md:w-1/2 flex justify-center items-center ${isReversed ? 'md:order-1' : ''}`}>
                 <div className="relative group w-full max-w-md aspect-square">
                    ...
                    <div className="absolute -bottom-6 -right-6 lg:-bottom-10 lg:-right-10 bg-dms-blue text-white p-6 lg:p-10 rounded-full shadow-2xl z-20 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-12">
                         <span className="text-[10px] font-black uppercase tracking-[0.4em] leading-none whitespace-nowrap block">Trust the Data</span>
                    </div>
                 </div>
            </div>
        </div>
        ...
        <div className="overflow-x-hidden pt-0 selection:bg-dms-blue selection:text-white">
            ...
            <section className="bg-dms-dark-gray text-white pt-56 pb-32 text-center relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <p className="text-xl md:text-3xl text-gray-400 max-w-2xl mx-auto font-light leading-relaxed animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                        We engineer growth through a synthesis of creative intelligence and cold, hard data.
                    </p>
                </div>
                ...
                <div className="container mx-auto px-6 text-center relative z-10">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h3 className="text-3xl md:text-6xl font-black text-dms-gray uppercase tracking-tighter mb-10 leading-tight">
                            Ready for a <span className="text-dms-blue">Definitive</span> Strategy?
                        </h3>
                        <p className="text-xl text-gray-500 font-light mb-12 max-w-2xl mx-auto">
                            Every brand is a puzzle. We have the data to solve yours. Let's build something dependable.
                        </p>
